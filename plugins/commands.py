...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/jass_robot_query'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/Jaspreet000/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/Jaspreet000/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/jass_robot_query'),     
        ],
        [
